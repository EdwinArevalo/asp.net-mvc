    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (Session["Products"] == null)
            {
                ...
                products.Add(new Product { ProductID = 1, Name = "Product1", Price = 10, Active = true });
                products.Add(new Product { ProductID = 2, Name = "Product2", Price = 20, Active = true });
                products.Add(new Product { ProductID = 3, Name = "Product3", Price = 30, Active = true });
                products.Add(new Product { ProductID = 4, Name = "Product4", Price = 40, Active = true });
                products.Add(new Product { ProductID = 5, Name = "Product5", Price = 50, Active = true });
